...
const ProductCard = ({ productImage, productName, productPrice, discountedPrice, id }) => {
  ...
  return (
    <div className='w-full md:w-[242px] lg:h-[307.26px] h-[330px] bg-white  relative group'>
      ...
      <div className='absolute top-0 right-0 bg-primary p-3 rounded-bl-xl'>
        <ShoppingCart className='w-5 h-5 text-white' onClick={() => dispatch(addToCart({ productImage, productName, productPrice, id }))} />
      </div>
    </div>
  )
}
